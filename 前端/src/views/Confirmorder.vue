<template>
    ...
    <div class="wrapper">
        ...
        <div class="bottom-btn">
            ...
            <div class="last" @click=Toappointmentsuccess>确认支付</div>
        </div>
...
const data = simplifyDateString(getSessionStorage("data"));

const hospital=getSessionStorage("hospitals");

const hpId = getSessionStorage("hpId");

const smId = getSessionStorage("smId");
